...
``Model.estimate_passenger_genes_r2``, and the ``gene_cv_passenger_r2``
wrapper that orchestrates them (see TODO.md's "Cross-validated R² test
for PCA n_components selection")."""
